...
public class TelaMenu{
	...
	private static JComboBox comboTradutor = null;
	 ...
	 private static JLabel lblIdioma = null;
	...
	private static boolean isLingua=false;
	...
	private void montarTradutorEnglish(){
		...
		sistemaMenu.setText("System");
		relatorioMenu.setText("Report");
		cadastroSubMenu.setText("Register");
		alteraSubMenu.setText("Change");
		removeSubMenu.setText("Remove");
		relatorioSubMenu.setText("Write to File");
		sobreMenu.setText("Over the Basic Bank");
		int select = comboBox.getSelectedIndex();
		comboBox.removeAllItems();
		comboBox.addItem("List");
		comboBox.addItem("Search");
		comboBox.setSelectedIndex(select);
		checkCresc.setText("Growing");
		checkDescresc.setText("Decreasing");
		checkNome.setText("Name");
		checkNumero.setText("Account Number");
		checkSaldo.setText("Balance");
		btnComfirmar.setText("Confirm");
	...
	private void montarTradutorPortugues(){
		...
		relatorioSubMenu.setText("Gravar em Arquivo");
		sobreMenu.setText("Sobre o Basic Bank");
		int select = comboBox.getSelectedIndex();
		if(select==-1){
	...
	private void montarEstrutura(){	
		...
		comboTradutor = new JComboBox(new String[]{"Português","English"});
		comboTradutor.addActionListener(new ActionListener() {
			
			public void actionPerformed(ActionEvent arg0) {
				
				if(comboTradutor.getSelectedIndex()==0){
					
					montarTradutorPortugues();
				} else if(comboTradutor.getSelectedIndex()==1){
		...
		relatorioSubMenu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				@SuppressWarnings({ "unused" })
				GerarRelatorio relatorio = new GerarRelatorio(tela,contasRelatorio,isLingua);
		...
		cadastroSubMenu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					telaCadastro = new TelaCadastro(tela,banco,isLingua);
		...
		removeSubMenu.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				 telaRemover = new TelaRemover(tela,banco,isLingua);				 
						if(selectCombo.equals("List")||selectCombo.equals("Listar")&&btnComfirmar.isEnabled()){
							contasLista = Banco.listTable();
							tableModel = new ContaTabelaModelo(contasLista,col1,col2,col3);
							tabela.setModel(tableModel);
		...
		alteraSubMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				telaAlterar = new TelaAlterar(tela,banco,isLingua);
	...
	private void montarOpListar(){		
		...
		springLayout.putConstraint(SpringLayout.NORTH, comboTradutor, 128, SpringLayout.NORTH, tela.getContentPane());
		springLayout.putConstraint(SpringLayout.WEST, comboTradutor, -128, SpringLayout.EAST, tela.getContentPane());
		springLayout.putConstraint(SpringLayout.EAST, comboTradutor, -38, SpringLayout.EAST, tela.getContentPane());
		tela.getContentPane().add(comboTradutor);
		...
		springLayout.putConstraint(SpringLayout.WEST, lblIdioma, 14, SpringLayout.WEST, comboTradutor);
		springLayout.putConstraint(SpringLayout.SOUTH, lblIdioma, 0, SpringLayout.NORTH, comboTradutor);
		springLayout.putConstraint(SpringLayout.EAST, lblIdioma, -50, SpringLayout.EAST, tela.getContentPane());
		lblIdioma.setForeground(Color.BLACK);
		lblIdioma.setFont(new Font("Tahoma", Font.PLAIN, 14));
		tela.getContentPane().add(lblIdioma);
